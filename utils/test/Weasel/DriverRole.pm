...
=item is_hidden($element_id)

Returns a boolean value indicating whether the element indicated by
C<$element_id> is hidden

=cut

sub is_hidden {
    croak "Abstract interface method 'is_hidden' called";
}

=item is_enabled($element_id)
...
sub is_enabled {
    croak "Abstract interface method 'is_enabled' called";
}
